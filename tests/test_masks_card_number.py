...
from tests.conftest import tests_masks_get_mask_card_number, tests_masks_get_mask_card_number_2, tests_masks_get_mask_card_number_3, tests_masks_get_mask_card_number_4, tests_masks_get_mask_card_number_5
